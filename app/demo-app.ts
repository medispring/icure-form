...
// @ts-ignore
import okido_main from './samples/okido.yaml'
// @ts-ignore
...
class DemoApp extends LitElement {
	...
	private samples = [
		...[
			...
			{ title: 'OKIDO', form: Form.parse(YAML.parse(okido_main)) },
			...
			{ title: 'OKIDO - Measure', form: Form.parse(YAML.parse(okido_measure)) },
