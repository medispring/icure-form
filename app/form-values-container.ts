...
export const makeFormValuesContainer = () => {
	const cc = new Contact({
		id: 'c2',
		services: [
			{ id: 's1', valueDate: 20181012, tags: [{ id: 'MS-ABORTION-APPOINTMENT-TIME-ITEM|commentary|1' }], content: { fr: { stringValue: 'Hello field modified' } } },
			{ id: 's2', tags: [{ id: 'MS-ABORTION-APPOINTMENT-TIME-ITEM|appointmentDate|1' }], content: { fr: { fuzzyDateValue: '19960823' } } },
		],
	})
	const ctc = new Contact({
		...
		services: [
			...
			{ id: 's2', tags: [{ id: 'MS-ABORTION-APPOINTMENT-TIME-ITEM|contactVia|1' }], content: { fr: { stringValue: 'Médecin' } } },
